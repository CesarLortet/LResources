...
<head>
    ...
    <link rel="stylesheet" href="gsr_style-min.css">
    <title>GSR Resources</title>
</head>

<body>
    <div class="sidebar shadow-2 bg-3">
        <div class="flex fx-center align-center">
            <img class="sidebar-logo" onclick="toggleTheme()" src="images/icons/favicon.ico" alt="gsr" height="50" width="50" /> 
        </div>
    ...
    <div class="content bg-1">
        <ul class="breadcrumb bg-2">
            <li>Getting Started</li>
        </ul>
        <div class="container">
            <h1 class="center">GSR - Resources</h1>
        ...
        &lt;!--- GSR Resources CSS --->
        &lt;link rel="stylesheet" href="https://res.globalsmartsolutions.tech/gsr_style-min.css">
        &lt;!--- GSR Resources JS --->
        &lt;script src="https://res.globalsmartsolutions.tech/gsr_script-min.js">&lt;/script></code></pre>
                    </section>
                    <section id="template">
...
&lt;head>
    ...
    &lt;link rel="stylesheet" href="https://res.globalsmartsolutions.tech/gsr_style-min.css">
    &lt;title>Getting started - GSR Resources&lt;/title>
&lt;/head>

&lt;body class="bg-1">
    &lt;div class="sidebar txt-white bg-3">
        &lt;h3 class="sidebar-logo"> Mon wonderfull website&lt;/h3>
        &lt;div>
            &lt;a href="#">Link 1&lt;/a>
            &lt;a href="#">Link 2&lt;/a>
            &lt;a href="#">Link 3&lt;/a>
...
&lt;/body>
&lt;/html>
&lt;script src="https://res.globalsmartsolutions.tech/gsr_script-min.js">&lt;/script>
</code></pre>
                    </section>
                </main>
            </section>
        ...
        &lt;/div></code></pre>
            ...
            <section id="icons">
                ...
                <main>
                    <pre class="morph-pressed rounded-2 bg-2"><code class="language-html">        &lt;img src="https://res.globalsmartsolutions.tech/images/icons/gsr256x.ico" alt="GSR 256x256"></code></pre>
                    <div class="container">
                        <div class="wrapper xs1 lg2">
                            <div class="txt-center">
                                ...
                                <div class="wrapper xs1 md3 lg3">
                                    <div class="txt-center">
                                        <img width="256" src="images/icons/gsr256x.ico" alt="GSR 256x256">
                                        <p>256x256</p>
                                        <p>gsr256x.ico</p>
                                    </div>
                                    <div class="txt-center">
                                        <img width="128" src="images/icons/gsr128x.ico" alt="GSR 128x128">
                                        <p>128x128</p>
                                        <p>gsr128x.ico</p>
                                    </div>
                                    <div class="txt-center">
                                        <img width="64"  src="images/icons/gsr64x.ico" alt="GSR 64x64">
                                        <p>64x64</p>
                                        <p>gsr64x.ico</p>
                                    </div>
                                </div>
        ...
        &lt;/div></code></pre>
                            ...
                            <section id="breadcrumb">
                                ...
                                <pre class="morph-pressed rounded-2 bg-2"><code class="language-html">        &lt;ul class="breadcrumb">
            &lt;li>&lt;a href="#">Link&lt;/a>&lt;/li>
            &lt;li>&lt;a href="#">Link&lt;/a>&lt;/li>
            &lt;li>&lt;a href="#">Link&lt;/a>&lt;/li>
            &lt;li>Active link&lt;/li>
...
<script src="gsr_script-min.js"></script>